...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r329.handleValues[0] + "%", ctx_r329.handleValues[1] - ctx_r329.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r330.handleValues[0] + "%", ctx_r330.handleValues[1] - ctx_r330.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r331.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r332.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r338); const ctx_r337 = ɵngcc0.ɵɵnextContext(); return ctx_r337.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r338); const ctx_r339 = ɵngcc0.ɵɵnextContext(); return ctx_r339.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r338); const ctx_r340 = ɵngcc0.ɵɵnextContext(); return ctx_r340.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r338); const ctx_r341 = ɵngcc0.ɵɵnextContext(); return ctx_r341.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r338); const ctx_r342 = ɵngcc0.ɵɵnextContext(); return ctx_r342.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r333 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r333.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r333.orientation == "horizontal" ? ctx_r333.handleValue + "%" : null, ctx_r333.orientation == "vertical" ? ctx_r333.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r333.tabindex)("aria-valuemin", ctx_r333.min)("aria-valuenow", ctx_r333.value)("aria-valuemax", ctx_r333.max)("aria-labelledby", ctx_r333.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r344 = ɵngcc0.ɵɵnextContext(); return ctx_r344.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r346 = ɵngcc0.ɵɵnextContext(); return ctx_r346.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r347 = ɵngcc0.ɵɵnextContext(); return ctx_r347.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r348 = ɵngcc0.ɵɵnextContext(); return ctx_r348.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r349 = ɵngcc0.ɵɵnextContext(); return ctx_r349.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r334 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r334.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r334.rangeStartLeft, ctx_r334.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r334.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r334.tabindex)("aria-valuemin", ctx_r334.min)("aria-valuenow", ctx_r334.value ? ctx_r334.value[0] : null)("aria-valuemax", ctx_r334.max)("aria-labelledby", ctx_r334.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r352 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r352); const ctx_r351 = ɵngcc0.ɵɵnextContext(); return ctx_r351.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r352); const ctx_r353 = ɵngcc0.ɵɵnextContext(); return ctx_r353.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r352); const ctx_r354 = ɵngcc0.ɵɵnextContext(); return ctx_r354.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r352); const ctx_r355 = ɵngcc0.ɵɵnextContext(); return ctx_r355.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r352); const ctx_r356 = ɵngcc0.ɵɵnextContext(); return ctx_r356.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r335 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r335.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r335.rangeEndLeft, ctx_r335.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r335.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r335.tabindex)("aria-valuemin", ctx_r335.min)("aria-valuenow", ctx_r335.value ? ctx_r335.value[1] : null)("aria-valuemax", ctx_r335.max)("aria-labelledby", ctx_r335.ariaLabelledBy);
} }
