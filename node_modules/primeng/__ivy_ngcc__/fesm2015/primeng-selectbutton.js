...
function SelectButton_div_1_ng_container_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r529 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(option_r529.icon);
...
function SelectButton_div_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r529 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", option_r529.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(option_r529.label || "ui-btn");
} }
...
function SelectButton_div_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r529 = ctx_r539.$implicit;
    const i_r530 = ctx_r539.index;
    const ctx_r534 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r534.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c1, option_r529, i_r530));
} }
...
function SelectButton_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SelectButton_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r541); const option_r529 = ctx.$implicit; const i_r530 = ctx.index; const ctx_r540 = ɵngcc0.ɵɵnextContext(); return ctx_r540.onItemClick($event, option_r529, i_r530); })("keydown.enter", function SelectButton_div_1_Template_div_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r541); const option_r529 = ctx.$implicit; const i_r530 = ctx.index; const ctx_r542 = ɵngcc0.ɵɵnextContext(); return ctx_r542.onItemClick($event, option_r529, i_r530); })("focus", function SelectButton_div_1_Template_div_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r541); const ctx_r543 = ɵngcc0.ɵɵnextContext(); return ctx_r543.onFocus($event); })("blur", function SelectButton_div_1_Template_div_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r541); const ctx_r544 = ɵngcc0.ɵɵnextContext(); return ctx_r544.onBlur($event); });
    ...
    const _r531 = ɵngcc0.ɵɵreference(1);
    const _r533 = ɵngcc0.ɵɵreference(4);
    const ctx_r528 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("ui-button ui-widget ui-state-default ui-button-text-only ", option_r529.styleClass, "");
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction5(11, _c2, ctx_r528.isSelected(option_r529), ctx_r528.disabled || option_r529.disabled, _r531 == ctx_r528.focusedItem, option_r529.icon != null, option_r529.icon && !option_r529.label));
    ɵngcc0.ɵɵattribute("aria-pressed", ctx_r528.isSelected(option_r529))("title", option_r529.title)("aria-label", option_r529.label)("tabindex", ctx_r528.tabindex)("aria-labelledby", ctx_r528.ariaLabelledBy);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r528.itemTemplate)("ngIfElse", _r533);
} }
