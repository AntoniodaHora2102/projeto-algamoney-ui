...
function Steps_li_2_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r553); const ctx_r554 = ɵngcc0.ɵɵnextContext(); const item_r547 = ctx_r554.$implicit; const i_r548 = ctx_r554.index; const ctx_r552 = ɵngcc0.ɵɵnextContext(); return ctx_r552.itemClick($event, item_r547, i_r548); })("keydown.enter", function Steps_li_2_a_2_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r553); const ctx_r556 = ɵngcc0.ɵɵnextContext(); const item_r547 = ctx_r556.$implicit; const i_r548 = ctx_r556.index; const ctx_r555 = ɵngcc0.ɵɵnextContext(); return ctx_r555.itemClick($event, item_r547, i_r548); });
    ...
    const item_r547 = ctx_r557.$implicit;
    const i_r548 = ctx_r557.index;
    const ctx_r550 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r547.url, ɵngcc0.ɵɵsanitizeUrl)("target", item_r547.target)("id", item_r547.id)("tabindex", item_r547.disabled || i_r548 !== ctx_r550.activeIndex && ctx_r550.readonly ? null : item_r547.tabindex ? item_r547.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r548 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r547.label);
} }
...
function Steps_li_2_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r559); const ctx_r560 = ɵngcc0.ɵɵnextContext(); const item_r547 = ctx_r560.$implicit; const i_r548 = ctx_r560.index; const ctx_r558 = ɵngcc0.ɵɵnextContext(); return ctx_r558.itemClick($event, item_r547, i_r548); })("keydown.enter", function Steps_li_2_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r559); const ctx_r562 = ɵngcc0.ɵɵnextContext(); const item_r547 = ctx_r562.$implicit; const i_r548 = ctx_r562.index; const ctx_r561 = ɵngcc0.ɵɵnextContext(); return ctx_r561.itemClick($event, item_r547, i_r548); });
    ɵngcc0.ɵɵelementStart(1, "span", 8);
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(3, "span", 9);
    ...
    const item_r547 = ctx_r563.$implicit;
    const i_r548 = ctx_r563.index;
    const ctx_r551 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r547.routerLink)("queryParams", item_r547.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", item_r547.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(15, _c0))("fragment", item_r547.fragment)("queryParamsHandling", item_r547.queryParamsHandling)("preserveFragment", item_r547.preserveFragment)("skipLocationChange", item_r547.skipLocationChange)("replaceUrl", item_r547.replaceUrl)("state", item_r547.state);
    ɵngcc0.ɵɵattribute("target", item_r547.target)("id", item_r547.id)("tabindex", item_r547.disabled || i_r548 !== ctx_r551.activeIndex && ctx_r551.readonly ? null : item_r547.tabindex ? item_r547.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r548 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r547.label);
...
function Steps_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r547 = ctx.$implicit;
    const i_r548 = ctx.index;
    const ctx_r546 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMap(item_r547.styleClass);
    ɵngcc0.ɵɵproperty("ngStyle", item_r547.style)("ngClass", ɵngcc0.ɵɵpureFunction4(8, _c1, i_r548 === ctx_r546.activeIndex, i_r548 !== ctx_r546.activeIndex, i_r548 < ctx_r546.activeIndex, item_r547.disabled || i_r548 !== ctx_r546.activeIndex && ctx_r546.readonly));
    ɵngcc0.ɵɵattribute("aria-selected", i_r548 === ctx_r546.activeIndex)("aria-expanded", i_r548 === ctx_r546.activeIndex);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !item_r547.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r547.routerLink);
} }
