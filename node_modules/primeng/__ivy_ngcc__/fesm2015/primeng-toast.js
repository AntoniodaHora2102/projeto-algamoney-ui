...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r602); const ctx_r601 = ɵngcc0.ɵɵnextContext(); return ctx_r601.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r602); const ctx_r603 = ɵngcc0.ɵɵnextContext(); return ctx_r603.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r599.message.severity == "info", ctx_r599.message.severity == "warn", ctx_r599.message.severity == "error", ctx_r599.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r599.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r599.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r609); const ctx_r608 = ɵngcc0.ɵɵnextContext(); return ctx_r608.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r609); const ctx_r610 = ɵngcc0.ɵɵnextContext(); return ctx_r610.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r606 = ctx.$implicit;
    const i_r607 = ctx.index;
    const ctx_r605 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r606)("index", i_r607)("template", ctx_r605.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r605.showTransformOptions)("hideTransformOptions", ctx_r605.hideTransformOptions)("showTransitionOptions", ctx_r605.showTransitionOptions)("hideTransitionOptions", ctx_r605.hideTransitionOptions);
} }
