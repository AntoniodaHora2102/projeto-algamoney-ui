...
function VirtualScroller_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r697 = ctx.$implicit;
    const i_r698 = ctx.index;
    const c_r699 = ctx.count;
    const f_r700 = ctx.first;
    const l_r701 = ctx.last;
    const e_r702 = ctx.even;
    const o_r703 = ctx.odd;
    const ctx_r695 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(3, _c1, ctx_r695.itemSize + "px"));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", item_r697 ? ctx_r695.itemTemplate : ctx_r695.loadingItemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(5, _c2, item_r697, i_r698, c_r699, f_r700, l_r701, e_r702, o_r703));
} }
