...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r84.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r91); const ctx_r90 = ɵngcc0.ɵɵnextContext(); return ctx_r90.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r85 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r85.rows)("first", ctx_r85.first)("totalRecords", ctx_r85.totalRecords)("pageLinkSize", ctx_r85.pageLinks)("alwaysShow", ctx_r85.alwaysShowPaginator)("rowsPerPageOptions", ctx_r85.rowsPerPageOptions)("dropdownAppendTo", ctx_r85.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r85.paginatorDropdownScrollHeight)("templateLeft", ctx_r85.paginatorLeftTemplate)("templateRight", ctx_r85.paginatorRightTemplate)("currentPageReportTemplate", ctx_r85.currentPageReportTemplate)("showCurrentPageReport", ctx_r85.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowIndex_r93 = ctx.index;
    const ctx_r86 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r86.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r92, rowIndex_r93));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r87.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r96); const ctx_r95 = ɵngcc0.ɵɵnextContext(); return ctx_r95.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r88 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r88.rows)("first", ctx_r88.first)("totalRecords", ctx_r88.totalRecords)("pageLinkSize", ctx_r88.pageLinks)("alwaysShow", ctx_r88.alwaysShowPaginator)("rowsPerPageOptions", ctx_r88.rowsPerPageOptions)("dropdownAppendTo", ctx_r88.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r88.paginatorDropdownScrollHeight)("templateLeft", ctx_r88.paginatorLeftTemplate)("templateRight", ctx_r88.paginatorRightTemplate)("currentPageReportTemplate", ctx_r88.currentPageReportTemplate)("showCurrentPageReport", ctx_r88.showCurrentPageReport);
} }
